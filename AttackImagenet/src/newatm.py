...
# MODEL_PATH = '../Models/IMAGENET5/imagenette_2.h5'
MODEL_PATH = './imagenette_1_large.h5'
INP_DATA_PATH = '../data/IMAGENET5/inputs_large.csv'
OUT_DATA_PATH = '../data/IMAGENET5/outputs_large.csv'

# INP_DATA_PATH = './fadv_img2_inputs.csv'
# OUT_DATA_PATH = './fadv_img2_outputs.csv'
