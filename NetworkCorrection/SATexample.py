...
MarabouNetwork.MarabouNetwork.addInequality(net1, [outputVars[3], outputVars[0]], [1, -1], 0) #Implies outputVars[3]-outputVars[0]<0 i.e outputVars[3]<outputVars[0]
MarabouNetwork.MarabouNetwork.addInequality(net1, [outputVars[3], outputVars[1]], [1, -1], 0)
MarabouNetwork.MarabouNetwork.addInequality(net1, [outputVars[3], outputVars[2]], [1, -1], 0)
MarabouNetwork.MarabouNetwork.addInequality(net1, [outputVars[3], outputVars[4]], [1, -1], 0)
