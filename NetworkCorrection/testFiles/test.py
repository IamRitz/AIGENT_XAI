...
# import Marabou as mb
import tensorflow as tf
from tensorflow import keras
import uuid
from WatermarkRemoval import utils

nnet_file_name = "/home/tooba/Documents/Marabou/resources/nnet/acasxu/ACASXU_experimental_v2a_2_9.nnet"
...
for i in range(sat_in.shape[0]):
    ...
    print("From net 1: ",net1.evaluate(sat_in[i].reshape(1,5)))
    print("From net 2: ",net2.evaluate(sat_in[i].reshape(1,5)))
