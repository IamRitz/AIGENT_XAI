...
class findCorrection:
    ...
    def run(self, model_name, num):
        ...
        print("Printing epsilons: ",n1.epsilons)
        return 
        ...
        unsat_epsilon, sat_epsilon, sat_vals = self.findEpsilon(n1) if self.lp else self.findEpsilonInterval(n1, lastlayer_inputs)
        predictions = inputs
