...
def getImages():
    ...
    for i in range(count):
        ...
        original = original.resize((32, 32))
        original_array = asarray(original).reshape(32*32*3)
        original_array = original_array/255.0
        # print(original_array)

        adversarial = Image.open('../Images/AdversarialImages'+str(folderSuffix)+'/'+paths[i])
        adversarial = adversarial.resize((32, 32))
        adversarial_array = asarray(adversarial).reshape(32*32*3)
